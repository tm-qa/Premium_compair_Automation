...
public class ComprehensivePolicyPage extends TestBase {

    public TestUtil tl;

    public ComprehensivePolicyPage()
    {
    ...
    public void comprehensiveCheckout(String fname, String lname) throws InterruptedException {
        ...
        ConBtn.click();
        Thread.sleep(7000);
        LogUtils.info("Premium updated");
        ConBtn.click();
        LogUtils.info("Waiting for Payment Option");
        Thread.sleep(7000);
        SelPayOpt.click();
        LogUtils.info("Payment Option Selected As Online");
        MakePay.click();
        LogUtils.info("Comprehensive Checkout Done");
    }
}
