...
public class ODPolicyPage extends TestBase {
    ...
    public void ownDamageCheckout(String fname, String lname) throws InterruptedException {
        ClickOntitle.click();
        SelectTitle.click();
        ...
        Thread.sleep(2000);
        Pyp.click();
        TpPolicyNo.sendKeys("345871237843578357834");
        ConBtn.click();
        ...
        SelPayOpt.click();
        MakePay.click();
        LogUtils.info("OwnDamage Checkout Done");
    }
}
